...
public class Camera {
    ...
    public void telemetryAprilTag(Telemetry telemetry) {
        ...
        for (AprilTagDetection detection : currentDetections) {
            if (detection.id == 20) {
                telemetry.addData("Detection Complete for Blue Goal Target", detection.id);
            }
            if (detection.id == 21) {
                telemetry.addData("Detection Complete for obelisk GPP", detection.id);
            }
            if (detection.id == 22) {
                telemetry.addData("Detection Complete for obelisk PGP", detection.id);
            }
            if (detection.id == 23) {
                telemetry.addData("Detection Complete for obellisk PPG", detection.id);
            }
            if (detection.id == 24) {
                telemetry.addData("Detection Complete for Red Goal Target", detection.id);
            }
